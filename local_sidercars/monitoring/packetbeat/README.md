...
[![Docker image](https://img.shields.io/docker/image-size/guardproject/packetbeat?label=image&logo=docker)](https://hub.docker.com/repository/docker/guardproject/packetbeat)
...
[Dockerfile](Dockerfile) is used to build the `docker` image with CI in the [https://hub.docker.com/repository/docker/guardproject/packetbeat](https://hub.docker.com/repository/docker/guardproject/packetbeat).
